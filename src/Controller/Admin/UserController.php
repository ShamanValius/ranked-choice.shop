...
class UserController extends AbstractController
{
     ...
     * @Route("/add", name="add")
     */
    public function edit(Request $request, UserFormHandler $userFormHandler, int $id = null): Response
    {
        $user = $userFormHandler->getUser($id);
     ...
     */
    public function delete(UserFormHandler $userFormHandler, UserManager $userManager, int $id): Response
    {
        $user = $userFormHandler->getUser($id);
