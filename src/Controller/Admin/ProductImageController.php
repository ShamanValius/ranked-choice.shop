...
class ProductImageController extends AbstractController
{
	 ...
	 */
	public function delete(ProductFormHandler $productFormHandler, ProductManager $productManager, ProductImageManager $productImageManager, int $id = null): Response
	{
		$productImage = $productFormHandler->getProductImage($id);
		if (!$productImage) {
