...
class CategoryController extends AbstractController
{
	...
	{
		$category = $categoryFormHandler->getCategory($id);
	 ...
	 */
	public function delete(int $id, CategoryFormHandler $categoryFormHandler, CategoryManager $categoryManager): Response
	{
		$category = $categoryFormHandler->getCategory($id);
